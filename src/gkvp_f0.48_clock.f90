    ...
    real(kind=DP)        :: ttotl
      ...
      if( isw == 0 ) then
        ...
        write( olog, '(a22,f15.5,i15)' ) "   other            = ", elt(2)-elt(10)-elt(11) &
                                          -elt(12)-elt(13)-elt(14)-elt(15)-elt(16), ccount(2)
        write( olog, * ) " #####################################################"
        ...
        write( olog, '(a22,f15.5,i15)' ) "   nlterm:input     = ", elt(1410), ccount(1410)
        write( olog, '(a22,f15.5,i15)' ) "   nlterm:backward  = ", elt(1420), ccount(1420)
        write( olog, '(a22,f15.5,i15)' ) "   nlterm:realspcal = ", elt(1430), ccount(1430)
        write( olog, '(a22,f15.5,i15)' ) "   nlterm:forward   = ", elt(1440), ccount(1440)
        write( olog, '(a22,f15.5,i15)' ) "   nlterm:output    = ", elt(1450), ccount(1450)
