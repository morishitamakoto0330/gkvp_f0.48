...
!%%% DIAG parameters %%%
  integer, parameter :: snum = 2      ! begining of simulation runs
  integer, parameter :: enum = 2      ! end of simulation runs
...
!$OMP parallel do
      ...
      write( pmominkxky, * ) "# set output './plt/mominkxky_t"//cloop//".jpg'"
