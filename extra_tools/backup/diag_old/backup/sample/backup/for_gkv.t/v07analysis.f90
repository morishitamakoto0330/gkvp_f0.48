...
!                gdens(mx,my,giz) =   dens(mx,my,iz)
!               gupara(mx,my,giz) =  upara(mx,my,iz)
!               gppara(mx,my,giz) =  ppara(mx,my,iz)
!               gpperp(mx,my,giz) =  pperp(mx,my,iz)
!              gqlpara(mx,my,giz) = qlpara(mx,my,iz)
!              gqlperp(mx,my,giz) = qlperp(mx,my,iz)
            end do
          end do
        end do
