...
!%%% Set parameters %%%
  ...
  integer, parameter :: nxw = 64, nyw = 32
  integer, parameter :: nx = 40, global_ny = 19  ! 2/3 de-aliasing rule
  integer, parameter :: global_nz = 16, global_nv = 16, global_nm = 15
  integer, parameter :: nzb = 2
  integer, parameter :: nprocw = 4, nprocz = 2, nprocv = 2, nprocm = 2, nprocs = 2
