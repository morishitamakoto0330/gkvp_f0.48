...
!$OMP parallel do private(wc2)
  ...
  !--- Electrostatic part of particle fluxes ---
      do is = 0, ns-1
!$OMP parallel do private(fct) reduction(+:p_flux_es,p_ampl_es)
        do iz = -global_nz, global_nz-1
  ...
  !--- Magnetic part of particle fluxes ---
      do is = 0, ns-1
!$OMP parallel do private(fct) reduction(+:p_flux_em,p_ampl_em)
        do iz = -global_nz, global_nz-1
          fct = grootg(iz) / cfsrf / real( 2*nxw, kind=DP )
          do my = 0, global_ny
            do mx = 0, 2*nxw-1
  ...
  !--- Electrostatic part of heat fluxes ---
      do is = 0, ns-1
!$OMP parallel do private(fct) reduction(+:h_flux_es,h_ampl_es)
        do iz = -global_nz, global_nz-1
          fct = grootg(iz) / cfsrf / real( 2*nxw, kind=DP )
          do my = 0, global_ny
            do mx = 0, 2*nxw-1
  ...
  !--- Magnetic part of heat fluxes ---
      do is = 0, ns-1
!$OMP parallel do private(fct) reduction(+:h_flux_em,h_ampl_em)
        do iz = -global_nz, global_nz-1
          fct = grootg(iz) / cfsrf / real( 2*nxw, kind=DP )
          do my = 0, global_ny
            do mx = 0, 2*nxw-1
