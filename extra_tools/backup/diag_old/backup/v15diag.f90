  ...
  ! --- local variables
    ...
    integer :: mx, my, iz, is
      ...
      open( omominxyz, file="./plt/phiinxyz_t"//cloop//".vtk" )
        ...
        write( omominxyz, '(A)' ) "3D data of the electric potential"
        write( omominxyz, '(A)' ) "ASCII"
        write( omominxyz, '(A)' ) "DATASET STRUCTURED_GRID"
        write( omominxyz, '(A,3I15)' ) "DIMENSIONS ", 2*nxw, 2*nyw, 2*global_nz
  
        write( omominxyz, '(A,I15,A)' ) "POINTS ", (2*nxw)*(2*nyw)*(2*global_nz), " float"
        do iz = -global_nz, global_nz-1
          do my = 0, 2*nyw-1
            do mx = 0, 2*nxw-1
            !--- GKV coordinates ---
              write( omominxyz, '(3G17.7E3)' ) xx(mx), yy(my), gzz(iz)
            !--- Cartesian coordinates ( s-alpha ) ---
            !  write( omominxyz, '(3G17.7E3)' ) ( r_minor/eps_r + (xx(mx)+r_minor)*cos( gzz(iz) ) ) * cos( q_0 * ( gzz(iz) + s_hat*xx(mx)*gzz(iz)/r_minor - yy(my)/r_minor ) ),  &
            !                                   ( r_minor/eps_r + (xx(mx)+r_minor)*cos( gzz(iz) ) ) * sin( q_0 * ( gzz(iz) + s_hat*xx(mx)*gzz(iz)/r_minor - yy(my)/r_minor ) ),  &
            !                                   ( xx(mx)+r_minor ) * sin( gzz(iz) )
            end do
          end do
        end do
  
        write( omominxyz, '(A,I15)' ) "POINT_DATA ", (2*nxw)*(2*nyw)*(2*global_nz)
      ...
      open( omominxyz, file="./plt/Alinxyz_t"//cloop//".vtk" )
        ...
        write( omominxyz, '(A)' ) "# vtk DataFile Version 2.0"
        write( omominxyz, '(A)' ) "3D data of the magnetic potential"
        write( omominxyz, '(A)' ) "ASCII"
        write( omominxyz, '(A)' ) "DATASET STRUCTURED_GRID"
        write( omominxyz, '(A,3I15)' ) "DIMENSIONS ", 2*nxw, 2*nyw, 2*global_nz
      ...
      do is = 0, ns-1
        ...
        open( omominxyz, file="./plt/densinxyz_ns"//cis//"_t"//cloop//".vtk" )
          ...
          write( omominxyz, '(A)' ) "# vtk DataFile Version 2.0"
          write( omominxyz, '(A)' ) "3D data of the density"
          write( omominxyz, '(A)' ) "ASCII"
          write( omominxyz, '(A)' ) "DATASET STRUCTURED_GRID"
          write( omominxyz, '(A,3I15)' ) "DIMENSIONS ", 2*nxw, 2*nyw, 2*global_nz
        ...
        open( omominxyz, file="./plt/uparainxyz_ns"//cis//"_t"//cloop//".vtk" )
          ...
          write( omominxyz, '(A)' ) "# vtk DataFile Version 2.0"
          write( omominxyz, '(A)' ) "3D data of the parallel velocity"
          write( omominxyz, '(A)' ) "ASCII"
          write( omominxyz, '(A)' ) "DATASET STRUCTURED_GRID"
          write( omominxyz, '(A,3I15)' ) "DIMENSIONS ", 2*nxw, 2*nyw, 2*global_nz
        ...
        open( omominxyz, file="./plt/presinxyz_ns"//cis//"_t"//cloop//".vtk" )
          ...
          write( omominxyz, '(A)' ) "# vtk DataFile Version 2.0"
          write( omominxyz, '(A)' ) "3D data of the pressure"
          write( omominxyz, '(A)' ) "ASCII"
          write( omominxyz, '(A)' ) "DATASET STRUCTURED_GRID"
          write( omominxyz, '(A,3I15)' ) "DIMENSIONS ", 2*nxw, 2*nyw, 2*global_nz
...
!$OMP parallel do
        ...
        open( omominxyz, file="./plt/qparainxyz_ns"//cis//"_t"//cloop//".vtk" )
          ...
          write( omominxyz, '(A)' ) "# vtk DataFile Version 2.0"
          write( omominxyz, '(A)' ) "3D data of the parallel heat flux"
          write( omominxyz, '(A)' ) "ASCII"
          write( omominxyz, '(A)' ) "DATASET STRUCTURED_GRID"
          write( omominxyz, '(A,3I15)' ) "DIMENSIONS ", 2*nxw, 2*nyw, 2*global_nz
