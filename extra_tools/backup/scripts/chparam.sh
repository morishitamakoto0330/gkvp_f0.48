...
CURRENTDIR=`pwd`
  ...
  OLD_WKDIR="\/large2\/z41049a\/gkvp\/f0.48\/applegate2007ppcf_salpha_lb\/linky0070_shatbetadep\/shat0286beta0250"
  NEW_WKDIR="\/large2\/z41049a\/gkvp\/f0.48\/applegate2007ppcf_salpha_lb\/linky0070_shatbetadep\/shat0786beta0100";   #echo ${NEW_WKDIR}
