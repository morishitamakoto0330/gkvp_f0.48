...
cat ./src/calc_entropybalance.awk | sed -e "s/R0_Lt =/R0_Lt = $R0_Lt/g" > wk.0.awk
...
gnuplot ./src/plot_tent.0.gn     # Time evolution of entropy balance for ions
gnuplot ./src/plot_teint.gn      # Time evolution of entropy balance for electric field
gnuplot ./src/plot_tent.0.zf.gn  # Time evolution of entropy balance for ions ( ky = 0 )
gnuplot ./src/plot_teint.zf.gn   # Time evolution of entropy balance for electric field ( ky = 0 )
gnuplot ./src/plot_tent.0.nz.gn  # Time evolution of entropy balance for ions ( ky /= 0 )
